 ...
 */
if ( is_admin() && ( isset( $_GET['page'] ) && 'avada-status' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) || ( fusion_doing_ajax() && ( ( isset( $_GET['action'] ) && ( 'fusion_check_api_status' === $_GET['action'] || 'fusion_create_forms_tables' === $_GET['action'] || 'awb_copy_multisite_global_options' === $_GET['action'] ) ) || ( isset ($_POST['action'] ) && 'awb_convert_images_in_media_library' === $_POST['action'] ) ) ) ) { // phpcs:ignore WordPress.Security.NonceVerification
